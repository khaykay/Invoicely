...
const Sidebar = () => {
  return (
    <>
      <div className="w-[90px] flex flex-col gap-5 h-[calc(100vh-52px)] items-center pt-8 border-r-[1.3px] border-[#E4E6EB] border-solid md:w-[70px] md:px-1 sm:hidden">
        <span className="flex flex-col items-center ">
          ...
          <span className="text-xs md:text-[9px]">Design</span>
        </span>
        <span className="flex flex-col items-center">
          <svg
            className="w-6 md:w-5"
          ...
          <span className="text-xs md:text-[9px]">Template</span>
        </span>
        <span className="flex flex-col items-center">
          <svg
            className="w-6 md:w-5"
          ...
          <span className="text-xs md:text-[9px]">Layout</span>
        </span>
        <span className="flex flex-col items-center">
          <svg
            className="w-6 md:w-5"
          ...
          <span className="text-xs md:text-[9px]">Color</span>
        </span>
        <span className="flex flex-col items-center">
          <svg
            className="w-6 md:w-5"
          ...
          <span className="text-xs md:text-[9px]">Background</span>
        </span>
      </div>
    </>
  );
