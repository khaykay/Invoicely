  ...
  return (
    <div className=" min-h-[85%] bg-white shadow  ">
      <div className="  h-full ">
        <div className="px-7 pt-7 pb-1 md:px-4 md:pt-4 md:pb-1">
          <div className="  ">
          ...
          <div className="text-[9.5px]  ">
            <div className="bg-[#f0f0f0] flex px-2 py-[0.65rem] rounded-t-md md:px-1 md:py-[0.5rem] md:gap-1 mt-3">
            ...
            {invoiceData?.itemDetails?.map((item) => (
              <div
                className="flex border-x border-b border-[#f0f0f0] border-solid px-2 py-[0.65rem] md:px-1 md:gap-2 md:py-[0.5rem]"
                key={item.id}
              >
        ...
        <div className="bg-[#2764F6] flex  px-7 py-4 md:p-4 text-[#fbfbfc]">
          <div className="basis-1/2">
            <div className="flex flex-col  ">
              ...
              <div>
                <span className="text-[9px]  md:text-[7.5px]">
                  Date Issued:{" "}
                </span>
                <span className="text-[9px]">{invoiceData?.dateIssued}</span>
              </div>
              <div>
                <span className="text-[9px]   md:text-[7.5px]">Due Date: </span>
